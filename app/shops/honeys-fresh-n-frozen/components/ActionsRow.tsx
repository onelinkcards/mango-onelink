  ...
  return (
    <>
      <div className="space-y-3 w-full max-w-full min-w-0" onClick={(e) => e.stopPropagation()}>
        ...
        {/* Row 2: Menu, Location – equal width, responsive */}
        <div className="grid grid-cols-2 gap-2 w-full min-w-0">
          <Link
            href="/menu"
        ...
        {/* Row 3: Zomato, Reviews – equal width, responsive */}
        <div className="grid grid-cols-2 gap-2 w-full min-w-0">
          {shopConfig.social?.zomato && (
            <Link
              href={shopConfig.social.zomato}
              onClick={(e) => e.stopPropagation()}
              className="min-w-0 h-11 rounded-2xl transition-all flex items-center justify-center gap-1.5 sm:gap-2 active:scale-[0.97] touch-manipulation font-semibold text-white hover:opacity-95"
              style={{
                background: '#9E1030',
